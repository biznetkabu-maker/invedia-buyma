...
from lib.intake_pipeline import build_record as _pipeline_build_record
from lib.intake_pipeline import evaluate as _pipeline_evaluate
from lib.intake_pipeline import write_to_sheet as _pipeline_write_to_sheet
from lib.intake_pipeline import write_to_sheet_quiet as _pipeline_write_to_sheet_quiet
...
# 非対話パイプライン処理は lib.intake_pipeline に分離。後方互換のため再エクスポート。
_evaluate = _pipeline_evaluate
_build_record = _pipeline_build_record
_write_to_sheet = _pipeline_write_to_sheet
_write_to_sheet_quiet = _pipeline_write_to_sheet_quiet
