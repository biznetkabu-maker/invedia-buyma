...
def _auto_fetch_buyma_info(buyma_url: str) -> object | None:
...
def _auto_search_supply_urls(
    ...
    supply_style_id: str,
    raw_product_name: str,
    official_match: object | None,
    preset_candidate_urls: list[str] | None,
    use_funnel: bool,
) -> list[str]:
...
def _run_auto_intake(
    *,
    ...
    upsert_name: str = "",
    skip_low_grades: bool = True,
    preset_candidate_urls: list[str] | None = None,
    use_funnel: bool = True,
) -> AutoIntakeOutcome:
